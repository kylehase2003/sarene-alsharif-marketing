...
- **2026-09-15**: Resolved edit note 16 (podcasts as guest appearances on established shows, not a new show, runs through the booking-outreach function). Restructured edit notes 17 and 18 into a direct ask, we need Sarene to send her existing talk/seminar recordings so a media library and speaker reel can be built, 18 is explicitly blocked on 17. Also flagged that edit note 15 (posting cadence) is blocked on both 13 (her weekly capacity) and 17/18 (what footage we'll actually have), not something to guess at in isolation.
