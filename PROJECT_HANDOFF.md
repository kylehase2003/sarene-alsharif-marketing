...
**`External-Skills/`**, catalogs of third-party skill libraries we're evaluating, not our code, not installed, just reference so the team knows what's available before wiring anything into `Action_Plan.md`:
- **`LinkedIn_Funnel_Skill.md`**: catalog of the 33-skill LinkedIn Funnel template (timscheuerai/linkedin-funnel), what it provides, and where it could plug into our Action Plan. Not integrated yet.
