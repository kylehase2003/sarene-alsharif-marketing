...
- Status: no posts or highlights archived, personal brand, history stays.
- Change needed: bio rewrite, to match current positioning as keynote speaker and workshop facilitator.

## 2. Landing Page

- Goal: convert an already-interested visitor into a booking inquiry.
- Contains: who she is, offer and pricing, proof points, video (once footage exists), the Values Gap Assessment, a direct booking form.

## 3. Values Gap Assessment

- Goal: a real check on whether a company's stated values show up in practice, leading into a workshop conversation.
...
4. **Good Leadership or Bad Leadership**: [link](https://docs.google.com/document/d/108W9hAOSy42_1siLho4pQFOilwr7MbOvldBgp6dk8Ps/edit?tab=t.nwmwa8mavo4r)

Note: script 4, one answer (defending an employee in front of a customer) is left blank on purpose, needs her real answer.
