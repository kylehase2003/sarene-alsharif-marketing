...
8. **Resolved (2026-09-15).** Split into two changes: a new "known for" point ("Leads by example first," growth and hard work start with her, same care extended to her team) and merged the old standalone "avoid hustle culture" item into the say-do-gap avoid item (hustle culture that glamorizes success at the cost of other people or their own stated values). Updated in Master Reference, Strategy File, and Client Presentation.
